...
class SuggestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post suggestions_url, params: { suggestion: { category: @suggestion.category, info: @suggestion.info, title: @suggestion.title } }, as: :json
    end
  ...
  test "should update suggestion" do
    patch suggestion_url(@suggestion), params: { suggestion: { category: @suggestion.category, info: @suggestion.info, title: @suggestion.title } }, as: :json
    assert_response 200
  end
